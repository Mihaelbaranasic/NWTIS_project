package edu.unizg.foi.nwtis.mbaranasi21.vjezba_05.dnevnik.podaci;

import java.net.InetAddress;
import java.net.UnknownHostException;

public record SustavInfo (String adresaRacunala, String ipAdresaRacunala, String nazivOS, String proizvodacVM, String verzijaVM, String direktorijVM, String direktorijRadni, String direktorijKorisnik) {
  ...
  public static SustavInfo preuzmiPodatke() throws UnknownHostException {
    ...
    return new SustavInfo(p_adresaRacunala, p_ipAdresaRacunala, p_nazivOS, p_proizvodacVM, p_verzijaVM, p_direktorijVM, p_direktorijRadni, p_direktorijKorisnik);
  }
}
