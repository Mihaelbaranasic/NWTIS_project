...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.servletContext.contextPath}/css/nwtis.css" type="text/css">
</head>
<body>
    ...
    <div class="filter-form">
        ...
        <div class="filter-links">
            <a href="${pageContext.servletContext.contextPath}/mvc/tvrtka/obracun?od=${param.od}&do=${param.do}">Svi obračuni</a> |
            <a href="${pageContext.servletContext.contextPath}/mvc/tvrtka/obracun/jelo?od=${param.od}&do=${param.do}">Samo jelo</a> |
            <a href="${pageContext.servletContext.contextPath}/mvc/tvrtka/obracun/pice?od=${param.od}&do=${param.do}">Samo piće</a>
        </div>
    </div>
    ...
    <div class="navigation">
        <a href="${pageContext.servletContext.contextPath}/mvc/tvrtka/pocetak">Povratak na početak</a>
    </div>
</body>
</html>